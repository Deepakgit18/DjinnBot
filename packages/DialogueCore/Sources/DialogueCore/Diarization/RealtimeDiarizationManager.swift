...
actor RealtimeDiarizationManager {
    ...
    public func processChunk(_ samples: [Float], at absoluteTime: TimeInterval) async {
        switch mode {
        case .sortformer:
    ...
    public func extractEmbedding(startTime: TimeInterval, endTime: TimeInterval) async -> [Float] {
