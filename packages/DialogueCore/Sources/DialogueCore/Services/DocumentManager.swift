...
public final class DocumentManager: ObservableObject {
    ...
    public static func setDialogueFolder(_ url: URL) {
    ...
    @Published public var fileTree: [FileTreeNode] = []
    ...
    public func setRootFolder(_ url: URL) {
        stopWatching()
        rootFolder = url
        refresh()
        startWatching()
    ...
    public func createNewDocument(title: String = "Untitled", in folder: URL? = nil) -> URL? {
    ...
    @discardableResult
    public func createFolder(named name: String, in parent: URL? = nil) -> URL? {
    ...
    public func allFolders() -> [(name: String, url: URL)] {
    ...
    @discardableResult
    public func renameItem(at url: URL, to newName: String) -> URL? {
    ...
    @discardableResult
    public func moveItem(at sourceURL: URL, toFolder destinationFolder: URL) -> URL? {
    ...
    public func mostRecentDocument() -> URL? {
    ...
    public func deleteItem(at url: URL) {
        do {
