...
public final class SpeakerProfile {
    ...
    public func updateEmbedding(with newEmbedding: [Float]) {
    ...
    public func cosineSimilarity(with other: [Float]) -> Float {
...
actor SpeakerProfileStore {
    ...
    public static let shared: SpeakerProfileStore? = try? SpeakerProfileStore()
    ...
    @MainActor
    public func resolveProfile(for embedding: [Float], streamPrefix: String) throws -> SpeakerProfile {
    ...
    @MainActor
    public func saveOrUpdateProfile(speakerId: String, displayName: String, embedding: [Float]) throws {
