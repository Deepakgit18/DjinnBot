...
enum TranscriptDocumentEditor {
    ...
    static func serialize(_ entries: [TranscriptEntry]) -> String {
    ...
    static func parse(_ text: String, original: [TranscriptEntry]) -> ParseResult {
...
struct ParseResult {
    ...
    let segments: [SegmentParseResult]
    ...
    func buildEntries() -> [TranscriptEntry] {
...
struct SegmentError: Identifiable {
    let id = UUID()
