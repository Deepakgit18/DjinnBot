...
public final class RealtimePipeline: @unchecked Sendable {

    // MARK: - Properties

    public let streamType: StreamType
    public let diarizationMode: DiarizationMode
    ...
    public init(streamType: StreamType, mode: DiarizationMode = .pyannoteStreaming) {
    ...
    public func processBuffer(_ buffer: AVAudioPCMBuffer, at absoluteTime: TimeInterval) {
